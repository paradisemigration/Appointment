          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <a 
                ...
                className="inline-flex items-center bg-gray-900 hover:bg-black text-white font-semibold py-4 px-8 rounded-xl shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
